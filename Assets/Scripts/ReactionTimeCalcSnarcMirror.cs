...
public class ReactionTimeCalcSnarcMirror : MonoBehaviour
{
	...
	private const int NumberOfTrials = 15; //15*8 //TODO: Trial numbers adjustment
	private int _say;
	...
	private IEnumerator SnarcBlock01() // TODO: BLOCK1
	{
		...
		for (var k = 0; k < 2; k++)
		{
			...
			for (var j = 0; j < 8; j++)
			{
				...
				_textParity = _randomNumber % 2 == 0 ? "Even" : "Odd";
				//rules normal Snarc
	...
	private string GetPath()
	{
		...
		var fileName = "/CSV/" + "id_" + SubjectId + "_Block_" + _blockNumber + "_mirrordata.csv";
