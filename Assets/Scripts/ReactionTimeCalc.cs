...
//	public float reactionTimer2;
	...
	//14- Get Id of the triggered fingers
...
//				}
				...
				Debug.Log("RT finger:" + DigitDetector()[11] + " and " + fingerRt[11]);
				...
				//TODO: GET ID of the triggered fingers
				
				var listB = new List<int>();

				for (var i = 0; i < fingerRt.LastIndexOf(0.0f); i++)
				{
					listB.Add(fingerRt.IndexOf(0.0f, i));
				}
